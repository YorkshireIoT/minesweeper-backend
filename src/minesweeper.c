...
static bool check_point(MINESWEEPER_POINT *point) {
    if (check_coordinate(point->x, MINESWEEPER_BOARD_WIDTH, "X") && check_coordinate(point->y, MINESWEEPER_BOARD_HEIGHT, "Y")) {
        return true;
    } else {
        return false;
    }
...
/**
 * @brief Changes the specified hidden or flagged point to its revealed equivalent.
 * 
 * @param grid  [in/out]    The grid containing the state of all points.
 * @param point [in]        The point to show
 */
static void show_point(MINESWEEPER_STATE grid[MINESWEEPER_BOARD_WIDTH][MINESWEEPER_BOARD_HEIGHT],
 ...
 * @param point [in]        The point to show
 */
static void show_all(MINESWEEPER_STATE grid[MINESWEEPER_BOARD_WIDTH][MINESWEEPER_BOARD_HEIGHT]) {
...
/**
 * @brief Pick a clear (not mine) point by revealing it and all adjacent points to it.
 * 
 * @param grid  [in/out]    The grid containing the state of all points.
 * @param point [in]        The point to pick.
 */
static void pick_clear_point(MINESWEEPER_STATE grid[MINESWEEPER_BOARD_WIDTH][MINESWEEPER_BOARD_HEIGHT],
                        MINESWEEPER_POINT *point) {
...
/**
 * @brief Pick a point on the grid and update the grid state with the proper effects
 * 
 * @param grid  [in/out]    The grid containing the state of all points.
 * @param point [in]        The point to pick.
 */
static MINESWEEPER_RESULT pick_point(MINESWEEPER_STATE grid[MINESWEEPER_BOARD_WIDTH][MINESWEEPER_BOARD_HEIGHT],
                                        MINESWEEPER_POINT *point) {
 ...
 */
static MINESWEEPER_RESULT flag_point(MINESWEEPER_STATE grid[MINESWEEPER_BOARD_WIDTH][MINESWEEPER_BOARD_HEIGHT],
                                        MINESWEEPER_POINT *point) {
    MINESWEEPER_RESULT result = MINESWEEPER_RESULT_SUCCESS;
    minesweeper_coordinate x = point->x;
    minesweeper_coordinate y = point->y;
...
MINESWEEPER_RESULT minesweeper_pick(MINESWEEPER_STATE grid[MINESWEEPER_BOARD_WIDTH][MINESWEEPER_BOARD_HEIGHT],
    ...
    if (is_init) {
        ...
        printf("Board not yet initialised. Please call minesweeper_reset() first.\n");
